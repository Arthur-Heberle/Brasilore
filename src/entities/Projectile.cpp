...
std::string Projectile::getType() const { return "Projectile"; }
...
void Projectile::setOwner(Entity *newOwner) {
  if (newOwner) {
    owner = newOwner;
  } else {
    cerr << "Attempted to set a null owner for the projectile!" << endl;
  }
}
